//No conseguido ocultar los precios de los ingredientes no seleccionados. Varias soluciones que implicarían cambiar el html y css
//los botones tardan 2 iteracciones en funcionar correctamente en add/remove class active
...
function renderPrice() {
  ...
  let totalPrice = basePrice; 
    ...
    // else {
    //   document.querySelector(".price li").style.display = 'none';
    // }
